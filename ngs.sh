...
#trim.sh = java -jar /Trimmomatic-0.39/trimmomatic-0.39.jar PE -threads 6 ./$1/$1\_1.fastq.gz ./$1/$1\_2.fastq.gz ./$1/$1\_output_forward_paired.fq.gz ./$1/$1\_output_forward_unpaired.fq.gz ./$1/$1\_output_reverse_paired.fq.gz ./$1/$1\_output_reverse_unpaired.fq.gz ILLUMINACLIP:/Trimmomatic-0.39/adapters/TruSeq3-PE.fa:2:30:10:2:True LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36
...
#bwa index -p tea GCF_004153795.1_AHAU_CSS_1_genomic.fna
...
#3.sh = hisat2  -x Tea.index -1 /home/scbb/$1/trim_data/*_*_forward_paired.fq -2 /home/$1/trim_data/*_*_reverse_paired.fq -S $1/out.sam -p 80

#ls -d SRR107526* |while read i; do bwa mem $i\_paired_1.fq.gz $i\_paired_2.fq.gz > $i.sam
